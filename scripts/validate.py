...
BODY_FIELDS = {
    ...
    "backend": ("Контекст", "Проблема", "Решение"),
    "mobile": ("Контекст", "Проблема", "Решение"),
    "desktop": ("Контекст", "Проблема", "Решение"),
    "data-ml": ("Контекст", "Проблема", "Решение"),
    "data-analysis": ("Контекст", "Проблема", "Решение"),
    "excel-research": ("Контекст", "Проблема", "Решение"),
    "powerbi": ("Контекст", "Проблема", "Решение"),
    "jira-confluence": ("Контекст", "Проблема", "Решение"),
    "devops": ("Контекст", "Проблема", "Решение"),
    "embedded": ("Контекст", "Проблема", "Решение"),
